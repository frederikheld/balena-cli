...
* Fix etcher-sdk related types [Marios Balamatsias]
* Bump etcher-sdk to 5.2.2 [Marios Balamatsias]
* Remove resin-image-fs typings [Marios Balamatsias]
* package.json: Remove resin-image-fs package [Marios Balamatsias]
* Replace old resin-image-fs with newer balena-image-fs [Marios Balamatsias]
